...
def process_webcam_frame(frame):
    ...
    # YOLO 탐지
    results = yolo_model(padded_frame, conf=0.5)  #yolo 모델 onfidence threshold 조정 (default:0.25)
    ...
    output_path = os.path.join(output_dir, "frame_with_boxes.jpg")
    cv2.imwrite(output_path, padded_frame)
    print(f"Saved YOLO detection image at: {output_path}")
